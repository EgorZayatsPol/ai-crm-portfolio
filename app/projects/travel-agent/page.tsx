...
export default function TravelAgentPage() {
  return <main className="min-h-screen overflow-hidden">
    ...
    <article className="px-5 py-24 sm:px-8 lg:px-12 lg:py-32"><div className="mx-auto max-w-6xl space-y-28">
      ...
      <section id="telegram-demo"><div className="grid gap-10 lg:grid-cols-[.72fr_1.28fr]"><div><p className="eyebrow">Telegram demo</p><h2 className="mt-5 text-3xl font-medium tracking-[-.05em] text-white sm:text-4xl">A travel conversation,<br /><span className="text-slate-400">inside the familiar interface.</span></h2><p className="mt-5 max-w-md leading-7 text-slate-400">Try Prague, Berlin, Warsaw, restaurants or cultural events. The chat is fully local: it uses predefined demo responses and does not send Telegram messages, search the web or call an external AI API.</p></div><TravelAgentDemo /></div></section>
